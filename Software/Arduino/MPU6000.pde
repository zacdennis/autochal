...
void MPU6000_Init(void)
{
    ...
    delay(1);
    MPU6000_SPI_write(MPUREG_GYRO_CONFIG,BITS_FS_250DPS);  // Gyro scale 2000º/s
    delay(1);
//    MPU6000_SPI_write(MPUREG_ACCEL_CONFIG,0x08);            // Accel scale 4g (8192LSB/g)
    MPU6000_SPI_write(MPUREG_ACCEL_CONFIG,BITS_FS_2G);        // Accel scale 2g (16384LSB/g), per diydrones.com/forum/topics/arduimu
    delay(1);   
