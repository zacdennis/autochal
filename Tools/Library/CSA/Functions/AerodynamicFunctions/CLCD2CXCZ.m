% CLCD2CXCZ Converts Aerodynamic Lift and Drag Coefficients (CL and CD) to Body Axis Coefficients (CX and CZ)
% -------------------------- UNCLASSIFIED ---------------------------
% ------------------ ITAR Controlled Work Product -------------------
% -------------- Northrop Grumman Proprietary Level 1 ---------------
% CLCD2CXCZ:
%   Converts Aerodynamic Lift and Drag Coefficients (CL and CD) to Body 
%   Axis Coefficients (CX and CZ)Using coordinate transformation.
%
% SYNTAX:
%	[CX,CZ] = CLCD2CXCZ(CL, CD, Alpha_deg)
%
% INPUTS: 
...
% MAIN EQUATIONS:
% 
% CX = -CD*cosd(Alpha_deg) + CL*sind(Alpha_deg);
% CZ = -CL*cosd(Alpha_deg) - CD*sind(Alpha_deg);
% 
% EXAMPLES:
%   Example 1: Singular Inputs
%   CL = 1; CD = 2; Alpha_deg = 45;
%   [CX, CZ] = CLCD2CXCZ(CL, CD, Alpha_deg)
%   returns CX = -0.7071, CZ = -2.1213
%
%   Example 2: Vectorized Inputs
%   CL = [1 1]; CD = [2 2]; Alpha_deg = 45;
%	[CX, CZ] = CLCD2CXCZ(CL, CD, Alpha_deg)
%   returns CX = [ -0.7071    -0.7071 ]       CZ = [ -2.1213   -2.1213 ]
%   Note, if CL & CD were column vectors, CX & CZ would be returned as such
%
%   Example 3: Matrix Inputs
%   CL = [1 2; 3 4]; CD = [5 6; 7 8]; Alpha_deg = 30;
%   [CX, CZ] = CLCD2CXCZ(CL, CD, Alpha_deg)
%   returns  CX = [ -3.8301   -4.1962;       CZ =  [   -3.3660   -4.7321;
...
%
% HYPERLINKS:
%     Source function: <a href="matlab:edit CLCD2CXCZ.m">CLCD2CXCZ.m</a>
%       Driver script: <a href="matlab:edit Driver_CLCD2CXCZ.m">Driver_CLCD2CXCZ.m</a>
%       Documentation: <a href="matlab:pptOpen('CLCD2CXCZ_Function_Documentation.pptx');">CLCD2CXCZ_Function_Documentation.pptx</a>
% Flight Dynamics Ref: <a href="\\vsishare1\VSI\Library\Juri Kalviste documents\FLIGHT DYNAMICS REF.pdf">Flight Dynamics Ref</a>
% 
% See also CXCZ2CLCD, CNCA2CLCD, CLCD2CNCA
%
%
% VERIFICATION DETAILS:
% Verified: Yes, Via Peer Review
% Trac Page: http://vodka.ccc.northgrum.com/trac/CSA/ticket/301
%
...
% $URL: https://svn.ngst.northgrum.com/repos/CSA/trunk/CSA/Functions/AerodynamicFunctions/CLCD2CXCZ.m $
% $Rev: 3029 $
% $Date: 2013-10-16 15:55:38 -0500 (Wed, 16 Oct 2013) $
% $Author: sufanmi $

function [CX,CZ] = CLCD2CXCZ(CL,CD,Alpha_deg)
