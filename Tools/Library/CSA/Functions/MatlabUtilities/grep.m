% GREP utility to find patterns in any files in folders and subfolders
% -------------------------- UNCLASSIFIED ---------------------------
...
% OUTPUTS: 
%	Name    	Size		Units		Description
%	pout	    <size>		<units>		<Description> 
%	p   	       <size>		<units>		<Description> 
%
% NOTES:
%		all folder separators are replaced by unix-style </> to facilitate
...
%
% HYPERLINKS:
%	Source function: <a href="matlab:edit grep.m">grep.m</a>
%	  Driver script: <a href="matlab:edit Driver_grep.m">Driver_grep.m</a>
%	  Documentation: <a href="matlab:pptOpen('grep_Function_Documentation.pptx');">grep_Function_Documentation.pptx</a>
%
...
% Verified: No
% Trac Page: http://vodka.ccc.northgrum.com/trac/CSA/ticket/450
%
...
% $URL: https://svn.ngst.northgrum.com/repos/CSA/trunk/CSA/Functions/MatlabUtilities/grep.m $
% $Rev: 1718 $
...
return; %end % << End of function grep >>
