% GENERATEINITIALEOMSTATE1 define inertial velocity to create IC struct for Oblate Earth EOM.
% -------------------------- UNCLASSIFIED ---------------------------
% ------------------ ITAR Controlled Work Product -------------------
% -------------- Northrop Grumman Proprietary Level 1 ---------------
% GenerateInitialEOMState1:
...
%
% SYNTAX:
%	[IC] = GenerateInitialEOMState1(mst, CentralBody, LLA, V_i, Alpha, ... 
%           Beta, Gamma, Chi, Mu, PQRb)
%
% INPUTS: 
...
%	[IC] = GenerateInitialEOMState1(mst, CentralBody, LLA, V_i, Alpha, Beta, Gamma, Chi, Mu, PQRb, varargin)
%	% <Copy expected outputs from Command Window>
%
%	% <Enter Description of Example #2>
%	[IC] = GenerateInitialEOMState1(mst, CentralBody, LLA, V_i, Alpha, Beta, Gamma, Chi, Mu, PQRb)
%	% <Copy expected outputs from Command Window>
%
...
%
% HYPERLINKS:
%	Source function: <a href="matlab:edit GenerateInitialEOMState1.m">GenerateInitialEOMState1.m</a>
%	  Driver script: <a href="matlab:edit Driver_GenerateInitialEOMState1.m">Driver_GenerateInitialEOMState1.m</a>
%	  Documentation: <a href="matlab:pptOpen('GenerateInitialEOMState1_Function_Documentation.pptx');">GenerateInitialEOMState1_Function_Documentation.pptx</a>
%
...
% Verified: No
% Trac Page: http://vodka.ccc.northgrum.com/trac/CSA/ticket/386
%
...
% $URL: https://svn.ngst.northgrum.com/repos/CSA/trunk/CSA/Functions/EquationsOfMotion/GenerateInitialEOMState1.m $
% $Rev: 1716 $
% $Date: 2011-05-11 17:12:24 -0500 (Wed, 11 May 2011) $
% $Author: healypa $

function [IC] = GenerateInitialEOMState1(mst, CentralBody, LLA, V_i, Alpha, Beta, Gamma, Chi, Mu, PQRb)
...
%  switch(nargin)
%       case 0
%        PQRb= ''; Mu= ''; Chi= ''; Gamma= ''; Beta= ''; Alpha= ''; V_i= ''; LLA= ''; CentralBody= ''; mst= ''; 
%       case 1
%        PQRb= ''; Mu= ''; Chi= ''; Gamma= ''; Beta= ''; Alpha= ''; V_i= ''; LLA= ''; CentralBody= ''; 
%       case 2
%        PQRb= ''; Mu= ''; Chi= ''; Gamma= ''; Beta= ''; Alpha= ''; V_i= ''; LLA= ''; 
%       case 3
%        PQRb= ''; Mu= ''; Chi= ''; Gamma= ''; Beta= ''; Alpha= ''; V_i= ''; 
%       case 4
...
IC.Euler_i  = ned2eci( IC.LLA(1), IC.LLA(2), mst, IC.Euler_ned )';  % [deg]
...
% 1.) Simply define the inertial velocity as components of IC.V_i0
%       For when they are known in any condition (direct and simple)
%       These plug straight into the inertial space integrators in the sim
...
end % << End of function GenerateInitialEOMState1 >>
