% VIAS2VTAS Converts indicated airspeed to true airspeed
% -------------------------- UNCLASSIFIED ---------------------------
% ------------------ ITAR Controlled Work Product -------------------
% -------------- Northrop Grumman Proprietary Level 1 ---------------
% vias2vtas:
%     Converts indicated airspeed to true airspeed based on altitude and
%     the COESA 1976 atmosphere model.
%
% SYNTAX:
%   [vtas] = vias2vtas(vias, Alt, flgUnits, DeltaTemp)
%   [vtas] = vias2vtas(vias, Alt, flgUnits)
%   [vtas] = vias2vtas(vias, Alt)
%   [vtas] = vias2vtas(vias)
%
% INPUTS:
...
%   The easiest usage would be to enter 'vias' and 'Alt' as either a scalar
...
%   to compute the true airspeed.  The units on the indicated airspeed are
%   irrelevant, but it should be understood that the outputted true
...
%
% EXAMPLES:
%	Example 1: Find the true airspeed of a plane flying at 9,000 feet alt
%	indicating 140 ft/s (default units). (Singular Inputs)
%	[vtas] = vias2vtas(140,9000)
%	Returns vtas= 160.3745
%
...
%
% HYPERLINKS:
%	Source function: <a href="matlab:edit vias2vtas.m">vias2vtas.m</a>
%	  Driver script: <a href="matlab:edit Driver_vias2vtas.m">Driver_vias2vtas.m</a>
%	  Documentation: <a href="matlab:pptOpen('vias2vtas_Function_Documentation.pptx');">vias2vtas_Function_Documentation.pptx</a>
%
% See also vtas2vias
%
%
...
% Trac Page: http://vodka.ccc.northgrum.com/trac/CSA/ticket/364
%
...
% $URL: https://svn.ngst.northgrum.com/repos/CSA/trunk/CSA/Functions/FlightParameters/vias2vtas.m $
% $Rev: 1716 $
% $Date: 2011-05-11 17:12:24 -0500 (Wed, 11 May 2011) $
% $Author: healypa $

function [vtas] = vias2vtas(vias, Alt, flgUnits, DeltaTemp)
...
% 100830 PBH: Updated function header with more descript notes on units and
%             sizes. Updated the format of the Equation used (in header, 
%             not actual function)    
...
%             NATE_TRANSFORMATIONS/vias2vtas.m
