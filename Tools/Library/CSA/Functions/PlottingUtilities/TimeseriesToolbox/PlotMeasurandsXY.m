% PLOTMEASURANDSXY Plots two measurands against each other(e.g. Lat vs Lon)
% -------------------------- UNCLASSIFIED ---------------------------
...
% 
% SYNTAX:
%	[arrHdl, strLegend] = PlotMeasurandsXY(SourceData2Plot, lstMeasurandSets, PO, varargin, 'PropertyName', PropertyValue)
%	[arrHdl, strLegend] = PlotMeasurandsXY(SourceData2Plot, lstMeasurandSets, PO, varargin)
%	[arrHdl, strLegend] = PlotMeasurandsXY(SourceData2Plot,
%	lstMeasurandSets, PO)
%
% INPUTS: 
...
%   {:,3}:  Legend Position for plot (default is 'NorthEast')
%
...
%	[arrHdl, strLegend] = PlotMeasurandsXY(SourceData2Plot, lstMeasurandSets, PO)
%	% <Copy expected outputs from Command Window>
%
...
%
% HYPERLINKS:
%	Source function: <a href="matlab:edit PlotMeasurandsXY.m">PlotMeasurandsXY.m</a>
%	  Driver script: <a href="matlab:edit Driver_PlotMeasurandsXY.m">Driver_PlotMeasurandsXY.m</a>
%	  Documentation: <a href="matlab:pptOpen('PlotMeasurandsXY_Function_Documentation.pptx');">PlotMeasurandsXY_Function_Documentation.pptx</a>
%
...
% Verified: No
% Trac Page: http://vodka.ccc.northgrum.com/trac/CSA/ticket/522
%
...
% $URL: https://svn.ngst.northgrum.com/repos/CSA/trunk/CSA/Functions/PlottingUtilities/TimeseriesToolbox/PlotMeasurandsXY.m $
% $Rev: 3145 $
% $Date: 2014-04-17 13:17:34 -0500 (Thu, 17 Apr 2014) $
% $Author: sufanmi $

function [arrHdl, strLegend] = PlotMeasurandsXY(SourceData2Plot, lstMeasurandSets, PO, varargin)
...
PO = format_struct(PO, 'UseXLimitsForXData', 0);
    ...
    for iMeas = 1:numMeasurands
        ...
        for iData2Plot = 1:numDataset;
            ...
            if(isempty(PO.PlotOrder))
                ...
                numCombos   = size(PO.PlotOrder, 1);
                iCombo      = min(ptrLine, numCombos);
                Color2Use   = PO.PlotOrder{iCombo,1};
                Marker2Use  = PO.PlotOrder{iCombo,2};
                Line2Use    = PO.PlotOrder{iCombo,3};
            end
            
            FullMarker2Use = [Color2Use Marker2Use Line2Use];
             
            lh = plotts_xy(tsx, tsy, FullMarker2Use, ...
            ...
            if((numMeasurands == 1) && (numDataset > 1))
                ...
                strLegend{ptrLine,:} = [strx ' vs. ' stry];
            end
...
end % << End of function PlotMeasurandsXY >>
