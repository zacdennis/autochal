...
%    ^^^^  tree view of all container components, their properties and
%    callbacks.
%
% SYNTAX:
%	[handles, levels, parentIdx, listing] = findjobj(container, varargin, 'PropertyName', PropertyValue)
%	[handles, levels, parentIdx, listing] = findjobj(container, varargin)
%	[handles, levels, parentIdx, listing] = findjobj(container)
%
% INPUTS: 
%	Name     	Size		Units		Description
%	container	<size>		<units>		<Description>
...
% OUTPUTS: 
%	Name     	Size		Units		Description
%	handles	  <size>		<units>		<Description> 
%	levels	   <size>		<units>		<Description> 
%	parentIdx	<size>		<units>		<Description> 
%	listing	  <size>		<units>		<Description> 
%
% NOTES:
...
%
% HYPERLINKS:
%	Source function: <a href="matlab:edit findjobj.m">findjobj.m</a>
%	  Driver script: <a href="matlab:edit Driver_findjobj.m">Driver_findjobj.m</a>
%	  Documentation: <a href="matlab:pptOpen('findjobj_Function_Documentation.pptx');">findjobj_Function_Documentation.pptx</a>
%
...
% Verified: No
% Trac Page: http://vodka.ccc.northgrum.com/trac/CSA/ticket/485
%
...
% $URL: https://svn.ngst.northgrum.com/repos/CSA/trunk/CSA/Functions/PlottingUtilities/findjobj.m $
% $Rev: 1724 $
