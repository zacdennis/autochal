% MEX_PLAYSOUND Compiler utility for playsound.c
% -------------------------- UNCLASSIFIED ---------------------------
...
% $URL: https://svn.ngst.northgrum.com/repos/CSA/trunk/CSA/SFunctions/PlaySound/mex_playsound.m $
% $Rev: 1704 $
