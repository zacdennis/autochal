 ...
 * c_minall.c
 * 
 * This is the MATLAB mex wrapper for the minall
 * C code contained in CSA_LIB.c.
 *
 * To mex this file, use mex_minall.m
 *
                  ...
                  int nrhs, const mxArray *prhs[])
{
  ...
  /* NOTE: You do not need an else statement when using mexErrMsgIdAndTxt
     ...
     the MEX-file) */
  if(nrhs!=1) 
    mexErrMsgIdAndTxt( "MATLAB:minall:invalidNumInputs",
            "One input required.");
  if(nlhs!=1) 
    mexErrMsgIdAndTxt( "MATLAB:minall:invalidNumOutputs",
            "One output required.");
